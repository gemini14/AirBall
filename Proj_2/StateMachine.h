...
public:
	...
	void  ChangeState(State<entity_type>* pNewState)
	{
		...
		// mod: changed to check for null, so that if a state is used to initialize something,
		// the enter function will be called (setting it the first time with setCurrentState does not
		// call Enter)
		if(m_pCurrentState)
